  ...
  return (
    <div className="min-h-screen bg-[#0d0015] p-8">
      <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-2 mb-8">
              {recent_diary.map((entry, i) => (
                <div
                  ...
                  className="flex items-center gap-3 bg-[#1a0a2e] rounded-lg p-3 border border-[#2d1b4e]/50 cursor-pointer hover:border-fuchsia-500/30 transition"
                >
                  {getCoverUrl(entry.game_cover_url) ? (
                    ...
                    <div className="w-10 h-14 bg-[#2d1b4e] rounded flex items-center justify-center text-[#8a6baa] text-[8px]">
                      ?
                    </div>
                  )}
          ...
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-8">
              {lists.map((list) => (
                <div
                  key={list.id}
                  className="bg-[#1a0a2e] rounded-xl p-4 border border-[#2d1b4e]/50"
                >
                  <p className="text-sm font-medium text-white">{list.name}</p>
                  <p className="text-[11px] text-[#8a6baa] mt-1">
        ...
        {stats.total_games === 0 && (
          <p className="text-[#8a6baa] text-center">
