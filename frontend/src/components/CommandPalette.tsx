...
function Kbd({ children }: { children: ReactNode }) {
  return (
    <kbd className="px-[5px] py-[1px] bg-[var(--cp-bg)] border border-[var(--cp-border)] rounded-[2px] mr-1 font-mono text-[10px] text-[var(--cp-text-dim)]">
      {children}
    </kbd>
  )
}
      ...
      >
        <div className="flex items-center gap-3 px-[18px] py-[14px] border-b border-[var(--cp-border)]">
          ...
          {filteredResults.length > 0 && (
            <span className="hidden sm:inline-flex items-center font-mono text-[10px] text-[var(--cp-text-dimmer)]">
              <Kbd>↵</Kbd>
            </span>
          )}
        </div>
        ...
        <div ref={listRef} className="p-2 max-h-[400px] overflow-y-auto">
          {!query.trim() ? (
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5 px-3 py-3">
              {recent.length > 0 && (
                <div>
                  <div className="font-mono text-[10px] uppercase tracking-[.12em] text-[var(--cp-text-dimmer)] mb-2">
                    Recent
                  </div>
            ...
            <div>
              <div className="font-mono text-[10px] uppercase tracking-[.12em] text-[var(--cp-text-dimmer)] px-3 py-1.5">
                Searching…
              </div>
              <ResultSkeleton />
              <ResultSkeleton />
            ...
            <div className="px-4 py-12 text-center">
              ...
              <div className="font-mono text-[10.5px] uppercase tracking-wider text-[var(--cp-text-dimmer)] mt-2">
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {sub && (
                        <div className="font-mono text-[10.5px] tracking-wider text-[var(--cp-text-dimmer)] truncate">
                          {sub}
                        </div>
                      )}
                    </div>
                    {active && (
                      <div className="font-mono text-[10px] uppercase tracking-wider text-[var(--cp-text-dim)] flex items-center gap-1 hidden sm:flex">
                        Open
                        <Kbd>↵</Kbd>
                      </div>
                    )}
        ...
        <div className="border-t border-[var(--cp-border)] px-3.5 py-2 flex justify-between items-center font-mono text-[10px] text-[var(--cp-text-dimmer)]">
